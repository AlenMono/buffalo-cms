...
export const planningList = [
  ...
  { href: '/pre-need-services', label: 'Pre-Need Services' },
  { href: '/at-need-services', label: 'At-Need Services' },
  { href: '/near-need-services', label: 'Near-Need Services' },
]

export const burialList = [
  { href: '/in-ground-burial', label: 'In Ground Burial' },
  { href: '/above-ground-mausoleum', label: 'Above Ground Mausoleum' },
  { href: '/above-ground-columbarium', label: 'Above Ground Columbarium' },
  { href: '/green-burial', label: 'Green Burial' },
]
